...
void sh_selftest(void) {
    ...
    sh_selftest_exec_expect("busybox chgrp", "usr/bin/busybox chgrp root /tmp/busybox-cp.txt", 0);
    ...
    sh_selftest_exec_expect("busybox find type", "usr/bin/busybox find /tmp -type f -name busybox-find-target", 0);
    ...
    sh_selftest_exec("busybox xargs zero", "usr/bin/busybox find /tmp -name busybox-find-target -print0 | usr/bin/busybox xargs -0 usr/bin/busybox echo busybox-xargs0-ok");
    ...
    sh_selftest_exec_expect("busybox stat format", "usr/bin/busybox stat -c busybox-stat-format:%n /tmp/busybox-touch.txt", 0);
    sh_selftest_exec_expect("busybox stat fs", "usr/bin/busybox stat -f /tmp", 0);
    ...
    sh_selftest_exec("busybox checksum prep", "echo busybox-checksum-ok | usr/bin/busybox tee /tmp/busybox-sum.txt");
    sh_selftest_exec_expect("busybox md5sum", "usr/bin/busybox md5sum /tmp/busybox-sum.txt", 0);
    sh_selftest_exec_expect("busybox sha1sum", "usr/bin/busybox sha1sum /tmp/busybox-sum.txt", 0);
    sh_selftest_exec_expect("busybox sha256sum", "usr/bin/busybox sha256sum /tmp/busybox-sum.txt", 0);
    sh_selftest_exec_expect("busybox gzip prep", "usr/bin/busybox cp /tmp/busybox-sum.txt /tmp/busybox-gzip.txt", 0);
    sh_selftest_exec_expect("busybox gzip", "usr/bin/busybox gzip -f /tmp/busybox-gzip.txt", 0);
    sh_selftest_exec_expect("busybox gunzip", "usr/bin/busybox gunzip -f /tmp/busybox-gzip.txt.gz", 0);
    sh_selftest_exec_expect("busybox gzip cat", "usr/bin/busybox cat /tmp/busybox-gzip.txt", 0);
    sh_selftest_exec_expect("busybox tar gz prep", "usr/bin/busybox tar -cf /tmp/busybox-autotar.tar /tmp/busybox-gzip.txt", 0);
    sh_selftest_exec_expect("busybox tar gzip", "usr/bin/busybox gzip -f /tmp/busybox-autotar.tar", 0);
    sh_selftest_exec_expect("busybox tar autodetect", "usr/bin/busybox tar -tf /tmp/busybox-autotar.tar.gz", 0);
    sh_selftest_exec_expect("busybox ls dir prep", "usr/bin/busybox mkdir /tmp/busybox-lsdir", 0);
