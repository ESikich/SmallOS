...
For Wolf3D sound, expose QEMU's SB16 and AdLib devices and attach both to an
audio backend, for example
`-audiodev sdl,id=audio0,out.frequency=48000,out.buffer-length=50000` plus
