...
USER_PROGS=echo about uptime halt reboot date pwd cat fsread ls tree touch rm mkdir rmdir cp mv edit bmpview diskview hello ticks args runelf_test readline exec_test waitprobe fileread compiler_demo heapprobe statprobe fileprobe cwdprobe stdioprobe dirprobe errnoprobe badptrprobe fault sleep_test timerfdprobe signalfdprobe connectprobe ptrguard spinwkr pgrpprobe preempt_test crtprobe displayprobe inputprobe plasma mandel tcpecho sockeof ftpd
