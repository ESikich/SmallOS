...
USER_PROGS=echo about uptime halt reboot pwd cat fsread ls fsls touch rm mkdir rmdir cp mv edit hello ticks args runelf_test readline exec_test fileread compiler_demo heapprobe statprobe fileprobe cwdprobe stdioprobe dirprobe errnoprobe fault sleep_test timerfdprobe ptrguard spinwkr preempt_test crtprobe tcpecho sockeof ftpd
