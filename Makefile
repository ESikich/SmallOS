...
USER_PROGS=echo about uptime halt reboot hello ticks args runelf_test readline exec_test fileread compiler_demo heapprobe statprobe fileprobe cwdprobe errnoprobe fault sleep_test ptrguard spinwkr preempt_test tcpecho ftpd
